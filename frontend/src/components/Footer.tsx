      ...
      <div className="flex flex-col items-center gap-6 mt-6 pb-2">
        ...
        >
          ...
          <svg 
            ...
            className="w-10 h-auto md:w-12 text-gold opacity-70 group-hover:opacity-100 group-hover:drop-shadow-[0_0_12px_rgba(205,162,85,0.8)] transition-all duration-500 animate-[spin_25s_linear_infinite]"
          >
            {/* Golden rectangles */}
